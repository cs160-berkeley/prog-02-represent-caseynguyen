...
public class ApiCall {
	...
	public static final String URL_CALL_TEMPLATE = "http://congress.api.sunlightfoundation.com/%API_CALL%/locate?apikey=%API_KEY%&";
	public static final String URL_CALL_TEMPLATE2 = "http://congress.api.sunlightfoundation.com/%API_CALL%?apikey=%API_KEY%";
	 ...
	 * @return
	 */
	public String callAPI2(String apiCall, Map<String, String> params) {
		String url = URL_CALL_TEMPLATE2.replace("%API_CALL%", apiCall);
		url = url.replace("%API_KEY%", getApiKey());
		url += buildPropertyString(params);
		return getUrlLines(url);
	}
	 ...
	 * @return
	 */
	public JSONObject getJSONResponse2(String apiCall, Map<String, String> params) {
		String s = callAPI2(apiCall, params);
		JSONTokener tokenizer = new JSONTokener(s);
