...
public class Legislator extends JSONEntity {
	 ...
	 * @return
	 */
	public static Legislator[] getLegislatorsForZipCode(ApiCall call, String zipcode, String latitude, String longitude) {
		Map<String, String> params = new HashMap<String, String>();
	...
	public static Legislator getLegislatorById(ApiCall call, Map<String, String> params) {
		...
		JSONObject item = JSONEntity.getJSONObject(call, params, apiCall, "legislator");
